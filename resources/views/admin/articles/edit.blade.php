...
@section('content')
    ...
    <ul class="nav nav-pills"id="first_ul">
        ...
        <li class="nav-item">
            <a class="nav-link disabled" href="{{url('/admin/articles/'.$art->id.'/edit')}}">修改文章</a>
        </li>
    </ul>
        <div class="container"style="margin-top: 20px">
            <form action="{{url('/admin/articles/'.$art->id)}}" method="post"enctype="multipart/form-data"id="formData">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" placeholder="请输入标题"name="title"value="{{$art->title}}">
                </div>
                <div class="form-group">
                    <label for="user">作者</label>
                    <input type="text" class="form-control" id="user" placeholder="请输入作者"name="user"value="{{$art->user}}">
                </div>
           {{--     <div class="form-group">
                ...
                @if($art->keyword1)
                    <input id="keyword1"type="text" name="keyword1"size="4"  readonly="true"style="display: inline;"value="{{$art->keyword1}}"/>
                @endif
                @if($art->keyword2)
                    <input id="keyword2"type="text" name="keyword2"size="4"  readonly="true"style="display: inline;"value="{{$art->keyword2}}"/>
                @endif
                @if($art->keyword3)
                    <input id="keyword3"type="text" name="keyword3"size="4"  readonly="true"style="display: inline;"value="{{$art->keyword3}}"/>
                @endif
                @if($art->keyword4)
                    <input id="keyword4"type="text" name="keyword4"size="4"  readonly="true"style="display: inline;"value="{{$art->keyword4}}"/>
                @endif
                @if($art->keyword5)
                    <input id="keyword5"type="text" name="keyword5"size="4"  readonly="true"style="display: inline;"value="{{$art->keyword5}}"/>
                @endif
                </div>
                <div class="form-group">
                    <label for="introduction">简介</label>
                    <input type="text" class="form-control" id="introduction" name="introduction"placeholder="请输入简介"value="{{$art->introduction}}">
                </div>
